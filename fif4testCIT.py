...
@app.callback(
    [Output('scoreboard2', 'children'),
     ...
     Output('scoreboardMonth', 'children'),
     Output('scoreboardYear', 'children'),
     Output('scoreboardNor', 'children'),
     Output('scoreboardHno', 'children'),
     Output('scoreboardAge', 'children'),
     Output('scoreboardWt', 'children'),
     Output('scoreboardSh', 'children')],

...
print(df['F#'].unique())
print(df['H. No'].unique())
print(df['Classification'].unique())
print(df['RESULT'].unique())
print(df['Class'].unique())
print(df['Distance'].unique())
print(df['NoR'].unique())
print(df['Race Time'].unique())
try:
    df['F#'].replace([np.nan],['F0'], inplace=True)
except:
    pass

try:
    df['H. No'].replace([np.nan],['F0'], inplace=True)
except:
    pass

try:
    df['H. No'].replace(['Rain'],['F0'], inplace=True)
except:
    pass

try:
    df['RESULT'].replace([np.nan],[0], inplace=True)
except:
    pass

try:
    df['RESULT'].replace(['Rain'],[0], inplace=True)
except:
    pass
...
try:
    df['R No.'].replace([np.nan], [0], inplace=True)
except:
    pass

try:
    df['NoR'].replace([np.nan], [0], inplace=True)
except:
    pass
...
try:
    df.Distance.replace(["1400 M", "1600 M", "1100 M", "1200 M", 1400, 1600, 1100, 1200, np.nan], ["1400M", "1600M", "1100M", "1200M","1400M", "1600M", "1100M", "1200M", "-"], inplace=True)
except:
    pass

combo=[(1, 0),(1, 1),(1, 2),(1, 3),(1, 4),(2, 0),(2, 1),(2, 2),(2, 3),(2, 4),(3, 0),(3, 1),(3, 2),(3, 3),(3, 4),(4, 0),(4, 1),(4, 2),(4, 3),(4, 4)]
race_stats = df.groupby(["Venue","Season Code","Date", "R No.", "Distance", "Class","NoR","Race Time", "f_r"], as_index=True).size().unstack(fill_value=0)
...
trinella = ['F123','F124','F132','F134','F142','F143','F213','F214','F231','F234','F241','F243','F312','F314','F321','F324','F341','F342','F412','F413','F421','F423','F431','F432']
exacta = ['F1234','F1243','F1324','F1342','F1423','F1432','F2134','F2143','F2314','F2341','F2413','F2431','F3124','F3142','F3214','F3241','F3412','F3421','F4123','F4132','F4213','F4231','F4312','F4321']
...
def generatebaroverall(dfff):
    c = list(["#7FB3D5", "#58D68D", "#F5B041", "#E59866", "#E5E7E9", "#AEB6BF", "#F5B7B1", "#E6B0AA", "#D2B4DE", "#DFFF00",
...
def gen_overall_centre_table(dff):
    a = [
        ...
        html.Thead([
            html.Tr([
                html.Th("Forecast", id='forecast_header', className='overallf1f4boxcolheader', colSpan=3, style={'width':'25%'}),
                html.Th("Quinella", id='quinella_header', className='overallf1f4boxcolheader', colSpan=3,
                        style={'width': '25%'}),
                html.Th("Trinella", id='trinella_header', className='overallf1f4boxcolheader', colSpan=3, style={'width':'25%'}),
                html.Th("Exacta", id='exacta_header', className='overallf1f4boxcolheader', colSpan=3, style={'width':'25%'})
            ])
        ]),
        html.Tr([
        ...
        html.Tr([
            ...
            html.Td("{}".format(round(dff[forecast[0]].value_counts(normalize=True).get(1,0)*100,2)), className='overallf1f4boxcell'),
            ...
            html.Td("{}".format(round(dff[trinella[0]].value_counts(normalize=True).get(1,0) * 100, 2)), className='overallf1f4boxcell'),
            ...
            html.Td("{}".format(round(dff[exacta[0]].value_counts(normalize=True).get(1,0) * 100, 2)), className='overallf1f4boxcell')
        ]),
        html.Tr([
...
def generate_overall_scoreboard(overall_dff,dff):
    Overall_SB = [html.Div(id='selected_filters'),
        ...
        html.Tr([
            ...
            html.Td("100%"),
            html.Td(html.Button("{}".format(len(overall_dff.loc[overall_dff['RESULT'] == 1])), id='overall_first_button',
                                n_clicks=0),
                    id='overall_first_pos'),
            html.Td("{0:.2f}".format((len(overall_dff.loc[overall_dff['RESULT'] == 1]) / len(overall_dff)) * 100),
                    id='overall_first_pct'),
            html.Td(html.Button("{}".format(len(overall_dff.loc[overall_dff['RESULT'] == 2])), id='overall_second_button',
                                n_clicks=0),
                    id='overall_second_pos'),
            html.Td("{0:.2f}".format((len(overall_dff.loc[overall_dff['RESULT'] == 2]) / len(overall_dff)) * 100),
                    id='overall_second_pct'),
            html.Td(html.Button("{}".format(len(overall_dff.loc[overall_dff['RESULT'] == 3])), id='overall_third_button',
                                n_clicks=0),
                    id='overall_third_pos'),
            html.Td("{0:.2f}".format((len(overall_dff.loc[overall_dff['RESULT'] == 3]) / len(overall_dff)) * 100),
                    id='overall_third_pct'),
            html.Td(html.Button("{}".format((len(overall_dff.loc[overall_dff['RESULT'] == 1]) + len(
                overall_dff.loc[overall_dff['RESULT'] == 2]) + len(overall_dff.loc[overall_dff['RESULT'] == 3]))),
                                id='overall_place_button', n_clicks=0),
                    id='overall_place_pos'),
            html.Td("{0:.2f}".format(
                ((len(overall_dff.loc[overall_dff['RESULT'] == 1]) + len(overall_dff.loc[overall_dff['RESULT'] == 2]) + len(
                    overall_dff.loc[overall_dff['RESULT'] == 3])) / len(overall_dff)) * 100), id='overall_place_pct'),
        ...
        html.Tr([
            ...
            html.Td(html.Button("{}".format(len(dff.loc[dff['RESULT'] == 1])), id='first_button', n_clicks=0),
                    id='first_pos'),
            html.Td("{0:.2f}".format((len(dff.loc[dff['RESULT'] == 1]) / len(dff)) * 100), id='first_pct'),
            html.Td(html.Button("{}".format(len(dff.loc[dff['RESULT'] == 2])), id='second_button', n_clicks=0),
                    id='second_pos'),
            html.Td("{0:.2f}".format((len(dff.loc[dff['RESULT'] == 2]) / len(dff)) * 100), id='second_pct'),
            html.Td(html.Button("{}".format(len(dff.loc[dff['RESULT'] == 3])), id='third_button', n_clicks=0),
                    id='third_pos'),
            html.Td("{0:.2f}".format((len(dff.loc[dff['RESULT'] == 3]) / len(dff)) * 100), id='third_pct'),
            html.Td(html.Button("{}".format((len(dff.loc[dff['RESULT'] == 1]) + len(
                dff.loc[dff['RESULT'] == 2]) + len(dff.loc[dff['RESULT'] == 3]))), id='place_button', n_clicks=0),
                    id='place_pos'),
            html.Td("{0:.2f}".format(((len(dff.loc[dff['RESULT'] == 1]) + len(dff.loc[dff['RESULT'] == 2]) + len(
...
def generate_overall_scoreboard_for_combo(overall_df,df, combination):
    Overall_SB = [html.Div(id='selected_filters'),
        ...
        html.Tr([
            ...
            html.Td("100%"),
            html.Td(html.Button("{}".format(len(overall_df.loc[overall_df[combination] == 1])), id='overall_first_button',
                                n_clicks=0),
                    id='overall_first_pos'),
            html.Td("{0:.2f}".format((len(overall_df.loc[overall_df[combination] == 1]) / len(overall_df)) * 100),
                    id='overall_first_pct'),
            html.Td(html.Button("{}".format(len(overall_df.loc[overall_df[combination] == 0])), id='overall_loss_button',
                                n_clicks=0),
                    id='overall_los_pos'),
            html.Td("{0:.2f}".format((len(overall_df.loc[overall_df[combination] == 0]) / len(overall_df)) * 100),
                    id='overall_loss_pct'),
            html.Td("{}".format(streak(overall_df[combination])[1]), id='overall_longest_winning_streak_data'),
            html.Td("{}".format(streak(overall_df[combination])[2]), id='overall_longest_losing_streak_data')
        ]),
        html.Tr([
            html.Td("Filtered", className='type_header'),
            html.Td("{}".format(len(df))),
            html.Td("{}%".format(round(((len(df)/len(overall_df))*100),2))),
            html.Td(html.Button("{}".format(len(df.loc[df[combination] == 1])), id='win_button', n_clicks=0),
                    id='first_pos'),
            html.Td("{0:.2f}".format((len(df.loc[df[combination] == 1]) / len(df)) * 100), id='win_pct'),
            html.Td(html.Button("{}".format(len(df.loc[df[combination] == 0])), id='loss_button', n_clicks=0),
                    id='loss_pos'),
...
def generate_favourite_scoreboard(xdf):
    ...
    fav_sb =    dash_table.DataTable(
                   id='table',
                   columns=[{"name": i, "id": i} for i in xdf[['TR','W','W%','SHP','SHP%','THP','THP%','Plc','Plc%','BO','LWS','LLS']].reset_index().columns],
                   data=xdf[['TR','W','W%','SHP','SHP%','THP','THP%','Plc','Plc%','BO','LWS','LLS']].reset_index().to_dict('records'),
                   editable=False,
                   export_columns='all',
                   export_format='xlsx',
                   #filterable=False,
...
filters = [
    ...
    html.Div(
        dcc.Dropdown(
                ...
                options=[{'label':'All', 'value':'All'}]+[{'label':i,'value':i} for i in sorted(df['Venue'].unique())],
                value='All',
                clearable=False
            ),
...
row2 = dbc.Row(
    [
        dbc.Col(html.Div(id='graphslot1', className='dash-graph'), width=12, className='pretty_container twelve columns', id='row2', style={'display': 'none'})
    ], className='flex-display'
)

row3 = dbc.Row(
    [
        dbc.Col(html.Div(id='graphslot2', className='dash-graph'), width=12, className='pretty_container twelve columns', id='row3', style={'display': 'none'})
    ], className='flex-display'
)

row4 = dbc.Row(
    [
        dbc.Col(html.Div(id='graphslot3', className='dash-graph'), width=12, className='pretty_container twelve columns', id='row4', style={'display': 'none'})
    ], className='flex-display'
)
...
@app.callback(
    [Output(component_id='combination', component_property='options'),
     ...
     Output(component_id='Time', component_property='value')],
...
def update_search_dropdown(type, Centre, how):
    ...
    time_options = [{"label": i, "value": i} for i in df['Race Time'].unique()]
    if Centre != 'All':
        ...
        time_options = [{"label": i, "value": i} for i in df.loc[df['Venue'] == Centre]['Race Time'].unique()]


    return[options, season_options, rno_options, class_options, distance_options, None, None, None, None,NoR_options,time_options,None,None]
...
def update_main(how, type, combination, Centre,*searchparam):
    ...
    cond = []
    cond_df =[]
    cols = ['Season Code', 'R No.', 'Distance', 'Class', 'NoR', 'Race Time']
    condition = []
    condition_df = []
    ...
    if len(filtered_race_stats) == 0:
        ...
        graph2 = [html.Div(), dcc.Graph(figure=generatebaroverall(filtered_race_stats), style={'height': '100%', 'width': '100%'})]
...
def updatebyseason(active_cell,data,season_df,class_df,distance_df,rno_df):

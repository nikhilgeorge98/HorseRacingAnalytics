...
data['front angle'] = data['front angle'] - 90
data['side angle'] = data['side angle'] - 90
...
axis[0,0].plot(data['frame'], data['front angle'])
axis[0,0].set_title("Hip range of motion(forward)")
axis[0,0].set_ylabel("Flexion/Extension(in deg)")

axis[0,1].plot(data['frame'], data['front angle'])
axis[0,1].set_title("Hip range of motion(forward)")
axis[0,1].set_ylabel("Flexion/Extension(in deg)")

axis[0,2].plot(data['frame'], data['front angle'])
axis[0,2].set_title("Hip range of motion(forward)")
axis[0,2].set_ylabel("Flexion/Extension(in deg)")

axis[1,0].plot(data['frame'], data['side angle'])
axis[1,0].set_title("Hip range of motion(sideways)")
axis[1,0].set_ylabel("Flexion/Extension(in deg)")

axis[1,1].plot(data['frame'], data['side angle'])
axis[1,1].set_title("Hip range of motion(sideways)")
axis[1,1].set_ylabel("Flexion/Extension(in deg)")

axis[1,2].plot(data['frame'], data['side angle'])
axis[1,2].set_title("Hip range of motion(sideways)")
axis[1,2].set_ylabel("Flexion/Extension(in deg)")

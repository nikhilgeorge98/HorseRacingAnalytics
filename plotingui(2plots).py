...
gs23 = tk.Label(gs_frame, height = 3, font=("Arial",13), text="{}".format(table_data.iloc[0, 1]), bg='#120024', fg='white').grid(row=1, column=1, sticky="nsew", pady=0)
...
gs33 = tk.Label(gs_frame, height = 3, font=("Arial",13), text="{}".format(table_data.iloc[1, 1]), bg='#120024', fg='white').grid(row=2, column=1, sticky="nsew", pady=0)
...
gs53 = tk.Label(gs_frame, height = 3, font=("Arial",13), text="{}".format(table_data.iloc[2, 1]), bg='#120024', fg='white').grid(row=4, column=1, sticky="nsew", pady=0)
...
gs63 = tk.Label(gs_frame, height = 3, font=("Arial",13), text="{}".format(table_data.iloc[3, 1]), bg='#120024', fg='white').grid(row=5, column=1, sticky="nsew", pady=0)
...
axis1[0].set_title("*insert title*")
axis1[0].set_ylabel("*insert y-label*")

axis1[1].plot(data['sideways angle'])
axis1[1].set_title("*insert title*")
axis1[1].set_ylabel("*insert y-label*")

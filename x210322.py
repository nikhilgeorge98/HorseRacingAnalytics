...
all_df = pd.concat(pd.read_excel(r'C:\Users\Testing\ALL CENTRES-DATA 210122.xlsx', sheet_name=None), ignore_index=True)
all_df.drop(columns=[ 'Season Race Day', 'CUP', 'NoH', 'Pedigree', 'Desc', 'Age', 'Wt', 'Al',  'Sh', 'Won By',
    ...
    for i in res[::-1]:
        ...
        if i in ['F/W', 'S/W', 'T/W']:
            ...
            if i == 'F/W':
                ...
                thpstreak = 0
                wstreak += 1
                ws = ws.replace(ws, "{}F/W".format(wstreak))
            elif i == 'T/W':
                if wstreak != 0:
                    streak += " " + ws
                elif shpstreak != 0:
                ...
                shpstreak = 0
                thpstreak += 1
                thps = thps.replace(thps, "{}T/W".format(thpstreak))
            elif i == 'S/W':
                if wstreak != 0:
                    streak += " " + ws
                elif thpstreak != 0:
                ...
                thpstreak = 0
                shpstreak += 1
                shps = shps.replace(shps, "{}S/W".format(shpstreak))
    if lstreak != 0:
        streak += " " + ls
    if Noplacestreak > 0:
        numNPS += 1
...
def generate_trainer_jockey_stats(df):
    ...
    Trainer_jockey_stats = pd.concat([n, m, l, k], axis=1)
...
def generate_trainer_stats(df):
    ...
    Trainer_stats = pd.concat([n, m, l, k], axis=1)
...
def generate_jockey_stats(df):
    ...
    Jockey_stats = pd.concat([n, m, l, k], axis=1)
...
def generate_jockey_trainer_stats(df):
    ...
    Jockey_Trainer_stats = pd.concat([n, m, l, k], axis=1)
    ...
    try:
        Overall_media_SB = [html.Div(id='selected_filters'),
            ...
            html.Tr([
                ...
                html.Td("100%"),
                html.Td(html.Button("{}".format(overall_media_race_stats['final'].value_counts().get('F/W',0)), id='overall_first_button',
                                    n_clicks=0),
                        id='overall_first_pos'),
                html.Td("{0:.2f}".format(round(safe_division(overall_media_race_stats['final'].value_counts().get('F/W',0), overall_media_race_stats['one'].value_counts().get(1,0))*100,2)),
                        id='overall_first_pct'),
                html.Td(html.Button("{}".format(overall_media_race_stats['final'].value_counts().get('S/W',0)), id='overall_second_button',
                                    n_clicks=0),
                        id='overall_second_pos'),
                html.Td("{0:.2f}".format(round(safe_division(overall_media_race_stats['final'].value_counts().get('S/W',0), overall_media_race_stats['two'].value_counts().get(1,0))*100,2)),
                        id='overall_second_pct'),
                html.Td(html.Button("{}".format(overall_media_race_stats['final'].value_counts().get('T/W',0)), id='overall_third_button',
                                    n_clicks=0),
                        id='overall_third_pos'),
                html.Td("{0:.2f}".format(round(safe_division(overall_media_race_stats['final'].value_counts().get('T/W',0), overall_media_race_stats['three'].value_counts().get(1,0))*100,2)),
                        id='overall_third_pct'),
                html.Td(html.Button("{}".format((overall_media_race_stats['final'].value_counts().get('F/W',0) + overall_media_race_stats['final'].value_counts().get('S/W',0) + overall_media_race_stats['final'].value_counts().get('T/W',0))),
                                    id='overall_place_button', n_clicks=0),
                        id='overall_place_pos'),
                html.Td("{0:.2f}".format(round(safe_division(overall_media_race_stats['final'].value_counts().get('F/W',0), overall_media_race_stats['one'].value_counts().get(1,0))*100 +
                                         safe_division(overall_media_race_stats['final'].value_counts().get('S/W',0), overall_media_race_stats['two'].value_counts().get(1,0))*100 +
                                         safe_division(overall_media_race_stats['final'].value_counts().get('T/W',0), overall_media_race_stats['three'].value_counts().get(1,0))*100, 2)), id='overall_place_pct'),
                html.Td(html.Button("{}".format(overall_media_race_stats['final'].value_counts().get('L',0)), id='overall_loss_button', n_clicks=0),
                        id='loss'),
                html.Td("{}".format(maxminstreaks_media('F/W', overall_media_race_stats['final'])[0]), id='overall_longest_winning_streak_data'),
                html.Td("{}".format(maxminstreaks_media('F/W', overall_media_race_stats['final'])[1]), id='overall_longest_losing_streak_data')
            ]),
            html.Tr([
                html.Td("Filtered", className='type_header'),
                html.Td("{}".format(len(media_race_stats))),
                html.Td("{}%".format(round((len(media_race_stats)/len(overall_media_race_stats))*100, 2))),
                html.Td(html.Button("{}".format(media_race_stats['final'].value_counts().get('F/W',0)), id='first_button', n_clicks=0),
                        id='first_pos'),
                html.Td("{0:.2f}".format(round(safe_division(media_race_stats['final'].value_counts().get('F/W',0), media_race_stats['one'].value_counts().get(1,0))*100,2)), id='first_pct'),
                html.Td(html.Button("{}".format(media_race_stats['final'].value_counts().get('S/W',0)), id='second_button', n_clicks=0),
                        id='second_pos'),
                html.Td("{0:.2f}".format(round(safe_division(media_race_stats['final'].value_counts().get('S/W',0), media_race_stats['two'].value_counts().get(1,0))*100,2)), id='second_pct'),
                html.Td(html.Button("{}".format(media_race_stats['final'].value_counts().get('T/W',0)), id='third_button', n_clicks=0),
                        id='third_pos'),
                html.Td("{0:.2f}".format(round(safe_division(media_race_stats['final'].value_counts().get('T/W',0), media_race_stats['three'].value_counts().get(1,0))*100,2)), id='third_pct'),
                html.Td(html.Button("{}".format((media_race_stats['final'].value_counts().get('F/W',0) + media_race_stats['final'].value_counts().get('S/W',0) + media_race_stats['final'].value_counts().get('T/W',0))), id='place_button', n_clicks=0),
                        id='place_pos'),
                html.Td("{0:.2f}".format(round(safe_division(media_race_stats['final'].value_counts().get('F/W',0), media_race_stats['one'].value_counts().get(1,0))*100 +
                                         safe_division(media_race_stats['final'].value_counts().get('S/W',0), media_race_stats['two'].value_counts().get(1,0))*100 +
                                         safe_division(media_race_stats['final'].value_counts().get('T/W',0), media_race_stats['three'].value_counts().get(1,0))*100, 2)), id='place_pct'),
                html.Td(html.Button("{}".format(media_race_stats['final'].value_counts().get('L',0)), id='loss_button', n_clicks=0),
                        id='loss'),
                html.Td("{}".format(maxminstreaks_media('F/W', media_race_stats['final'])[0]), id='longest_winning_streak_data'),
                html.Td("{}".format(maxminstreaks_media('F/W', media_race_stats['final'])[1]), id='longest_losing_streak_data')
            ])
        ], id='overall_sb_table')]
...
def generate_split_scoreboard(xdf,searchterm, title):
    if searchterm == 'Jockey':
        ...
        ttype = "Jockey"
    header = html.H3("{} {} stats".format(title, ttype),
                     style={'textAlign': 'center', 'font-weight': 'bold', 'color': '#59ff00', 'margin': '0px',
                            'font-family': 'Arial Black'})
    split_sb = dash_table.DataTable(
                       # id='split_table',
                       columns=[{"name": i, "id": i} for i in xdf[['TR','TR%','W','W%','SHP','SHP%','THP','THP%','Plc','Plc%','BO','F1%','F2%','F3%','LWS','LLS']].loc[searchterm[0]].reset_index().columns],
                       data=xdf[['TR','TR%','W','W%','SHP','SHP%','THP','THP%','Plc','Plc%','BO','F1%','F2%','F3%','LWS','LLS']].loc[searchterm[0]].reset_index().to_dict('records'),
                       editable=False,
                       #filterable=False,
                       #filter_action="none",
...
def generate_favourite_scoreboard(xdf):
    ...
    fav_sb =    dash_table.DataTable(
                   # id='table',
                   columns=[{"name": i, "id": i} for i in xdf[['TR','TR%','W','W%','SHP','SHP%','THP','THP%','Plc','Plc%','BO','LWS','LLS']].reset_index().columns],
                   data=xdf[['TR','TR%','W','W%','SHP','SHP%','THP','THP%','Plc','Plc%','BO','LWS','LLS']].reset_index().to_dict('records'),
                   editable=False,
                   #filterable=False,
                   #filter_action="none",
                   filter_action="native",
...
def generate_additional_scoreboards(xdf, type):
    ...
    fav_sb =    dash_table.DataTable(
                   # id='table',
                   columns=[{"name": i, "id": i} for i in xdf[['TR','TR%','W','W%','SHP','SHP%','THP','THP%','Plc','Plc%','BO','F1%','F2%','F3%','LWS','LLS']].reset_index().columns],
                   data=xdf[['TR','TR%','W','W%','SHP','SHP%','THP','THP%','Plc','Plc%','BO','F1%','F2%','F3%','LWS','LLS']].reset_index().to_dict('records'),
                   editable=False,
                   #filterable=False,
                   #filter_action="none",
                   filter_action="native",
...
def generate_distance_stats(dff):
    ...
    dist_stats = pd.concat([n, m, l, k], axis=1)
...
def generate_dr_stats(dff):
    ...
    dr_stats = pd.concat([n, m, l, k], axis=1)
...
def generate_media_race_stats(df, paper):
    paper_df = df[['Season', 'Date', 'Race No', 'Pl', paper]].copy()
    ...
    race_stats = paper_df.groupby(["Season", "Date", "Race No", "check_res"], as_index=True).size().unstack(
        fill_value=0)
    ...
    race_stats['final'] = race_stats[(1, 1)] + race_stats[(2, 1)] + race_stats[(3, 1)]
    race_stats['final'].replace([0, 1, 2, 3], ['L', 'F/W', 'S/W', 'T/W'], inplace=True)
...
def update_all_dropdowns(Centre):
    ...
    return[[current_centre_df.to_json(orient='split')],None, None, None, None, None, None, None, None, None]
...
def update_main_dropdown(searchtype, frame):
    ...
    if searchtype in ['OO','LO','MO','FO']:
        ...
        options = [{"label": i, "value": i} for i in media_list]
    else:
        options = [{'label': i, 'value': i} for i in sorted(df[searchtype].unique())]
    if searchtype == 'Media':
        multiple = False
    else:
        multiple = True
    return[options, None, None, None, None, None, None, None, None, None, multiple]
...
def update_filter_dropdowns(searchterm,searchtype, frame):
    ...
    if searchterm is None or searchterm == []:
        return [[],[],[],[],[],dis,[],[],None,None,None,None,None,None,None,None]
    if searchtype == "Jockey":
        dis = True
    if searchtype == 'Media':
        s = [{"label": i, "value": i} for i in df['Season'].unique()]
        d = [{"label": i, "value": i} for i in sorted(df['Distance'].unique())]
        c = [{"label": i, "value": i} for i in df['Classification'].unique()]
        t = [{"label": i, "value": i} for i in sorted(df['Trainer'].unique())]
        j = [{"label": i, "value": i} for i in sorted(df['Jockey'].unique())]
        rn = [{"label": i, "value": i} for i in sorted(df['Race No'].unique())]
        dr = [{"label": i, "value": i} for i in sorted(df['Dr'].unique())]
    else:
        s = [{"label": i, "value": i} for i in df.loc[df[searchtype].isin(searchterm)]['Season'].unique()]
        d = [{"label": i, "value": i} for i in sorted(df.loc[df[searchtype].isin(searchterm)]['Distance'].unique())]
        c = [{"label": i, "value": i} for i in df.loc[df[searchtype].isin(searchterm)]['Classification'].unique()]
        t = [{"label": i, "value": i} for i in sorted(df.loc[df[searchtype].isin(searchterm)]['Trainer'].unique())]
        j = [{"label": i, "value": i} for i in sorted(df.loc[df[searchtype].isin(searchterm)]['Jockey'].unique())]
        rn = [{"label": i, "value": i} for i in sorted(df.loc[df[searchtype].isin(searchterm)]['Race No'].unique())]
        dr = [{"label": i, "value": i} for i in sorted(df.loc[df[searchtype].isin(searchterm)]['Dr'].unique())]
    return[s, d, c, t, j, dis, rn, dr,None,None,None,None,None,None,None,None]
...
def display_scoreboard(frame, searchterm,searchtype,odds_type,*searchparam):
    ...
    if searchterm is None or searchterm == [] or searchterm == "":
        return [[], {'display': 'none'}, overall_stats, [], [], [], [], {'display': 'initial', 'background-color': '#061e44', 'margin-right':'0px'}, {'display': 'none'}, {'display': 'none'}, {'display': 'none'}, {'display': 'none'}, {'display': 'none'}, {'display': 'none'}, {'display': 'none'}, {'display': 'none'}, {'display': 'none'}, [], {'display': 'none'}, [], {'display': 'none'}, [], {'display': 'none'}, {'display': 'none'}, {'display': 'none'}, []]
    print(searchterm,'-',searchtype)
    if searchtype != 'Media':
    ...
    cond = []
    cols = ['Season', 'Distance', 'Classification', 'Trainer', 'Jockey', 'Race No', 'Dr', odds_type]
    condition = []
    ...
    if searchtype == 'Media':
        ...
        return [
            ...
            {'display': 'initial'},
            [],
            [html.Div([html.Div("Streaks:", className='streak_header'), "{}".format(streak_media(media_race_stats['final'])[0])],
                      id='streak_display'),
             html.Div(id="form", children=[
                 ...
                 html.Ul(id='form_guide_ul',
                     className='form_guide_ul_first',
                         children=[generate_li_for_media('F/W', i, j, n) for n, (i, j) in
                                  enumerate(zip(media_race_stats['final'][::-1],
                                                media_race_stats['final'][::-1]))])])],
            ...
            [], {'display': 'initial'}, [], {'display': 'none'}, [], {'display': 'none'}, {'display': 'none'},
            {'display': 'none'}, [media_race_stats.to_json(orient='index')]]
        ...
        return[
            ...
            {'display': 'initial'},
            generate_split_scoreboard(XDF, searchterm, "Unfiltered"),
            {'display': 'initial'},
            {'display': 'initial'},
            {'display': 'initial'},
            []
        ...
        return [
                ...
                odds_summary, {'display': 'initial'}, [], {'display': 'none'},[], {'display': 'none'}, {'display': 'none'}, {'display': 'none'}, []]
...
def update_form_win(clicks, frame, media_race_frame, sclicks, tclicks, pclicks, searchterm):
    ...
    if searchterm in media_list:
        ...
        return ["LWS(F->W)",
                "LLS(F->W)",
                "{}".format(maxminstreaks_media('F/W', media_race_stats['final'])[0]),
                "{}".format(maxminstreaks_media('F/W', media_race_stats['final'])[1]),
                dash.no_update,
                0,
                0,
                0,
...
def update_form_shp(clicks, frame, media_race_frame, fclicks, tclicks, pclicks, searchterm):
    ...
    if searchterm in media_list:
        ...
        return ["LWS(S->W)",
                "LLS(S->W)",
                "{}".format(maxminstreaks_media('S/W', media_race_stats['final'])[0]),
                "{}".format(maxminstreaks_media('S/W', media_race_stats['final'])[1]),
                dash.no_update,
                0,
                0,
                0,
...
def update_form_thp(clicks, frame, media_race_frame, fclicks, sclicks, pclicks, searchterm):
    ...
    if searchterm in media_list:
        ...
        return ["LWS(T->W)",
                "LLS(T->W)",
                "{}".format(maxminstreaks_media('T/W', media_race_stats['final'])[0]),
                "{}".format(maxminstreaks_media('T/W', media_race_stats['final'])[1]),
                dash.no_update,
                0,
                0,
                0,
...
def update_form_place(clicks, frame, media_race_frame, fclicks, sclicks, tclicks, searchterm):
    ...
    if searchterm in media_list:
        ...
        return ["LWS(Any->W)",
                "LLS(Any->W)",
                "{}".format(streak_media(media_race_stats['final'])[1]),
                "{}".format(streak_media(media_race_stats['final'])[2]),
                dash.no_update,
                0,
                0,
                0,
...
def update_F0_form_win(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, sclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type='Jockey'
    cond = []
    cols = ['Season', 'Jockey', 'Trainer', 'Distance', 'Race No', 'Dr', 'Classification']
    searchparam = [favseason,favjockey,favtrainer,favdistance,faveraceno,favdr,favclass]
    condition = []
    for (key, value) in zip(cols, searchparam):
        # print(key,'=',value)
...
def update_F0_form_shp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F0_form_thp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F0_form_place(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, tclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F1_form_win(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, sclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F1_form_shp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F1_form_thp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F1_form_place(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, tclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F2_form_win(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, sclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F2_form_shp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F2_form_thp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F2_form_place(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, tclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F3_form_win(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, sclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F3_form_shp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F3_form_thp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F3_form_place(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, tclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F4_form_win(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, sclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F4_form_shp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F4_form_thp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F4_form_place(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, tclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F5_form_win(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, sclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F5_form_shp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F5_form_thp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F5_form_place(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, tclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F6_form_win(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, sclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F6_form_shp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F6_form_thp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F6_form_place(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, tclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F7_form_win(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, sclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F7_form_shp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F7_form_thp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F7_form_place(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, tclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F8_form_win(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, sclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F8_form_shp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F8_form_thp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F8_form_place(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, tclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F9_form_win(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, sclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F9_form_shp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F9_form_thp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F9_form_place(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, tclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F10_form_win(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, sclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F10_form_shp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F10_form_thp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F10_form_place(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, tclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F11_form_win(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, sclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F11_form_shp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F11_form_thp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F11_form_place(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, tclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F12_form_win(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, sclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F12_form_shp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F12_form_thp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F12_form_place(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, tclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F13_form_win(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, sclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F13_form_shp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F13_form_thp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F13_form_place(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, tclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F14_form_win(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, sclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F14_form_shp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F14_form_thp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F14_form_place(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, tclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F15_form_win(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, sclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F15_form_shp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F15_form_thp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F15_form_place(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, tclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F16_form_win(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, sclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F16_form_shp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, tclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F16_form_thp(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, pclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def update_F16_form_place(clicks, frame, favseason, favjockey, favtrainer, favdistance, faveraceno, favdr, favclass, fclicks, sclicks, tclicks, searchterm):
    if clicks == 0:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    split_by_type = 'Jockey'
...
def generate_graphs(frame, searchterm, searchtype):
    ...
    if len(searchterm)==1:
        return [
            ...
            [{'label': 'All jockeys', 'value': 'All'}] + [{'label': i, 'value': i} for i in sorted(dff['Jockey'].unique())],
            [{'label': 'All trainers', 'value': 'All'}] + [{'label': i, 'value': i} for i in sorted(dff['Trainer'].unique())],
            [{'label': 'All distances', 'value': 'All'}] + [{'label': i, 'value': i} for i in sorted(dff['Distance'].unique())],
            [{'label': 'All race no.s', 'value': 'All'}] + [{'label': i, 'value': i} for i in sorted(dff['Race No'].unique())],
            [{'label': 'All Dr', 'value': 'All'}] + [{'label': i, 'value': i} for i in sorted(dff['Dr'].unique())],
...
def update_fav_detailed_table_season(favseason,favjockey,favtrainer,favdistance,faveraceno,favdr,favclass,frame):
    if frame is None or frame==[]:
        raise PreventUpdate
    dff = pd.read_json(frame[0], orient='split')
    cond = []

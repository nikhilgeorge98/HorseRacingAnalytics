...
def update_main(Method, *searchparam):
    ...
    R0df, R1df, R2df,ytr = generate_qualified_horse_summary(TrackedRuns)
    if len(qualifying_races) == 0:
        ...
        tableytr= generate_horse_run_result_summary_table(ytr,'table_ytr', 'Yet to run')

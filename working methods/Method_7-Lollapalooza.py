...
def generate_TrackedRuns(df, qualified_horses):
    ...
    for i in zerothindex:
        ...
        if (i + 1 in races_Q_horses.index):
            if (races_Q_horses.loc[i + 1, 'Horse'] == races_Q_horses.loc[i, 'Horse'] and races_Q_horses.loc[i + 1, 'Sh'] == 'A' and (races_Q_horses.loc[i + 1, 'Distance'] in [1200, 1400])):
                print("here")
                races_Q_horses.loc[i + 1, 'RunNo.'] = 1
            elif (races_Q_horses.loc[i + 1, 'Horse'] == races_Q_horses.loc[i, 'Horse'] and (races_Q_horses.loc[i + 1, 'Sh'] != 'A' or (races_Q_horses.loc[i + 1, 'Distance'] not in [1200, 1400]))):
